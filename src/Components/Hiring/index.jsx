...
import style from "./hiringStyle.module.css";
    ...
    <div>
      <div className={style.hiring}>
        <div className={style.hiringBox}>
          ...
          <p data-aos="fade-up">
            We filter through numerous applications to find and vet the finest
            talent. Tell us what you need & we’d get it to you in record time.
            Here’s how to hire remote developers in the easiest and quickest
            way.
          </p>

          <label>
            <h2 className={style.hiringHeadH2} data-aos="fade-up">
            ...
            <span className={style.textbox}>
              ...
              <span className={style.textTwo}>
                <h2 className={style.talentHead} data-aos="fade-up">
                  Interview Vetted Talent
                </h2>
                <p data-aos="fade-up">
